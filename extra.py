...
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐅𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 Facebook 𝐩𝐫𝐨𝐟𝐢𝐥𝐞")
os.system('espeak -a 300 " FOLLOW MY FACEBOOK PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100082550437979')
...
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[1;31m       _________    __    __________  _   __
\033[1;97m   / ____/   |  / /   / ____/ __ \/ | / /
\033[1;34m  / /_  / /| | / /   / /   / / / /  |/ / 
\033[1;35m / __/ / ___ |/ /___/ /___/ /_/ / /|  /  
\033[1;32m/_/   /_/  |_/_____/\____/\____/_/ |_/                                                                                     
     ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
     ║ \33[0;44m[ ALAMIN TERMUX COMUNITY😈🤟 ]\033[0;92m ║
     ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMD-ALAMIN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md Alamin ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mALAMIN-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01871553459 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/mdnuman123/Boss.txt').text
    if id in httpCaht:
      print("\33[1;32m[•] 𝐘𝐨𝐮 𝐤𝐞𝐲 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐲 𝐀𝐩𝐨𝐫𝐨𝐯𝐞𝐝")
      os.system('espeak -a 300 " permission granted"')
      time.sleep(0.2)
      os.system('espeak -a 300 " WELCOME TO ALAMIN KING FILE CLONING TOOLS"')
      msg = str(os.geteuid())
      time.sleep(0.5)
      menu()
    else:
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+8801871553459?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(https://github.com/mdnuman123/Boss.txt).text
    try:
        httpCaht = requests.get(f"https://github.com/mdnuman123/Boss.txt").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
            ...
            sys.exit()
def monu():
    correct_access_key = "Khfbuwkbcjoks17499@utooeiohfk"
    attempts = 0
